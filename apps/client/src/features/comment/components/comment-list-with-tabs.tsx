        ...
        <div style={{ flex: 1, minWidth: 0, position: "relative" }}>
          ...
          {focused && (
            <ActionIcon
              ...
              loading={isLoading}
              style={{
                // Занимает всю высоту поля и прилегает сразу к трём
                // стенкам: правой, верхней и нижней.
                position: "absolute",
                // 10 и 2 — отступы самого редактора внутри обёртки
                // (замерено: обёртка 261..310, поле 271..308). Ещё 2px
                // с трёх сторон — на рамку подсветки, которую поле
                // рисует снаружи: без этого между ней и кнопкой щель.
                top: 8,
                bottom: 0,
                right: -2,
              }}
