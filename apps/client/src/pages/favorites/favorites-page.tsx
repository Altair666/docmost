...
import GristFavoritesPage from "@/custom-sso/GristFavoritesPage";
...
export default function FavoritesPage() {
  // У нашего вида свои столбцы, сортировка и закреплённые пространства —
  // он живёт отдельным модулем. Выключен — список апстрима выше.
  const { customUi } = useUiFlags();
  return customUi ? <GristFavoritesPage /> : <StockFavoritesPage />;
}
