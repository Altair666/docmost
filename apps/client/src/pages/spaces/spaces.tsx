...
import GristSpaces from "@/custom-sso/GristSpaces";

function StockSpaces() {
...
export default function Spaces() {
  // У нашего списка свой заголовок, ширина поля, сортировка и фильтр из
  // шапки — он живёт отдельным модулем.
  const { customUi } = useUiFlags();
  return customUi ? <GristSpaces /> : <StockSpaces />;
}
