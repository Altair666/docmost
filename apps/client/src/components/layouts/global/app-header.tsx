...
import GristHeader from "@/custom-sso/GristHeader";

const links = [
  { link: APP_ROUTE.HOME, label: "Home" },
];

function StockAppHeader() {
...
export function AppHeader() {
  // Наш интерфейс живёт отдельным модулем; выключен — показываем шапку
  // апстрима выше, ничего в ней не трогая.
  const { customUi } = useUiFlags();
  return customUi ? <GristHeader /> : <StockAppHeader />;
}
