...
#
# Большие цифры ниже — про сборку образа на этой же машине. Она
# добавляет исходники, слои сборки и кеш; на шести гигабайтах памяти
# сборка клиента уже вешала машину целиком, когда рядом работали другие
# контейнеры.
#
# Если образ приезжает готовым, столько не нужно: смотрите RUN_ONLY.
MIN_FREE_MB=4000
MIN_DISK_GB=10

# Для запуска без сборки. Запас к замеру двойной: журналы, обновления
# образа и рост базы.
RUN_FREE_MB=1000
RUN_DISK_GB=4
